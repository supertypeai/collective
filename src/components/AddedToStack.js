            ...
            <div className="m-2 rounded border p-2">
                ...
                </div>
                {
                    ...
                    (<>
                        ...
                        <PillsFromSelected id="1" stackExamples={stackExamples} setStackExamples={setStackExamples} />
                    </>)
                }
                {
                    ...
                    (<>
                        ...
                        <PillsFromSelected id="2" stackExamples={stackExamples} setStackExamples={setStackExamples} />
                    </>)
                }
                {
                    ...
                    (<>
                        ...
                        <PillsFromSelected id="3" stackExamples={stackExamples} setStackExamples={setStackExamples} />
                    </>)
                }
            </div>
        </div>
