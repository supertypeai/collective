...
export const Mainframe = ({ children, data }) => {
  ...
  return (
    <MeContext.Provider value={data}>
      ...
      {/* <!-- Main content --> */}
      <main className={`max-w-7xl mx-auto gap-4 backdrop-blur-lg rounded drop-shadow-lg my-12 break-words bg-gradient-to-r from-amber-700 to-rose-900 mb-6 shadow-xl rounded-lg`} id="mainframe">
